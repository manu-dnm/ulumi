...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const runForm = true; // False to prevent form
        ...
        if (error) {
            ...
            if (modalContent !== null) {
                ...
                modalContent.innerHTML = '🚨 ¡Oh no! Nos falta el número de Whats y el webhook de Zapier.';
            }
        }
                ...
                fetch(webhookURL, {
                    ...
                    .then((response) => {
                        if (response.ok) {
                            ...
                            window.location.href = `/gracias-redirect`;
